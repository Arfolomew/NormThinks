...
I came across the pi ratio by accident, reading something else entirely, and couldn't shake the feeling that there was a whole argument hiding inside it. Rivers don't "know" about pi. They're just water following physics. But the physics conspires to produce something that looks, from the right altitude, like geometry. That gap between the dumb mechanism and the elegant outcome is the thing I find genuinely strange about the physical world.
